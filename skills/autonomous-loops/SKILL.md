...
>
> **Superseded (Jun 2026):** Loop Engineering (`loop-engineering` skill) is the new canonical paradigm. See `skills/loop-engineering/` for the complete framework including `/goal`, `/loop`, Dynamic Workflows (ultracode), 5+1 building blocks, and L0-L3 readiness levels.
