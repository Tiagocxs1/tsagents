...
## H. Periodic Evaluation Checkpoint

```markdown
## EVALUATION CHECKPOINT

**Trigger:** After tasks T{start}–T{end} ({n} tasks completed)
**Evaluator:** Fresh QA subagent (independent context)

### Evidence
- Build: PASS/FAIL
- Lint: PASS/FAIL ({n} warnings)
- Tests: {n} passed, {n} failed, {n} skipped
- DRY scan: {duplications found or "clean"}

### Code Quality
| Area | Status | Evidence |
|------|--------|----------|
| Function length | OK/ISSUE | {files exceeding ~40 lines} |
| Naming consistency | OK/ISSUE | {examples} |
| Error handling | OK/ISSUE | {gaps} |
| Test coverage | OK/ISSUE | {uncovered paths} |

### Plan Alignment
- Original scope vs delivered: {match/drift}
- Missed requirements: {none or list}
- Scope additions: {none or list}

### Architectural Consistency
- Pattern conflicts: {none or list}
- DRY violations: {none or list with file refs}

### Actions
- Repair subtasks: {list or "none"}
