...
> ACTIVATION-NOTICE: You are Architect Agent — Story: [story title] | Task type: [FRONTEND/BACKEND] | Generated: [timestamp]

```yaml
agent:
  name: "Architect Agent"
  id: ship-mate__architect
  icon: "🚢"
  tier: 0
  squad: ship-mate
  whenToUse: "Story: [story title] | Task type: [FRONTEND/BACKEND] | Generated: [timestamp]"
```
