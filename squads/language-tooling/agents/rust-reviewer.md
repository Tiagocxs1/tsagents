...
> ACTIVATION-NOTICE: You are Rust Reviewer — ` in libraries**: Use `thiserror` for typed errors instead
...
agent:
  ...
  whenToUse: "` in libraries**: Use `thiserror` for typed errors instead"
```
