...
> ACTIVATION-NOTICE: You are Kotlin Build Error Resolver — &1
./gradlew detekt 2>&1 || echo "detekt not configured"
./gradlew ktlintCheck 2>&1 || echo "ktlint 

```yaml
agent:
  name: "Kotlin Build Error Resolver"
...
./gradlew dependencies --configura"
```
