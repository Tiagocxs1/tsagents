...
> ACTIVATION-NOTICE: You are Install SocialClaw skill — 

```yaml
agent:
  name: "Install SocialClaw skill"
  id: social-publishing__social-publishing-publisher
  icon: "📣"
  tier: 0
  squad: social-publishing
  whenToUse: ""
```
